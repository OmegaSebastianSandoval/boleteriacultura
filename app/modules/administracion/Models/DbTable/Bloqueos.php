...
class Administracion_Model_DbTable_Bloqueos extends Db_Table
{
	...
	public function insert($data){
		...
		$query = "INSERT INTO bloqueos( bloqueo_usuario, bloqueo_fechaintento, bloqueo_intentosfallidos) VALUES ( '$bloqueo_usuario', '$bloqueo_fechaintento', '$bloqueo_intentosfallidos')";
	...
	public function update($data,$id){
		...
		$bloqueo_intentosfallidos = $data['bloqueo_intentosfallidos'];
		$query = "UPDATE bloqueos SET  bloqueo_usuario = '$bloqueo_usuario', bloqueo_fechaintento = '$bloqueo_fechaintento', bloqueo_intentosfallidos = '$bloqueo_intentosfallidos' WHERE bloqueo_id = '".$id."'";
		$res = $this->_conn->query($query);
	}
}