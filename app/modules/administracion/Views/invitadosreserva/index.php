			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="reserva_id_reserva"
							value="<?php echo $this->getObjectVariable($this->filters, 'reserva_id_reserva') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="invitadoReserva_nombre_invitado"
							value="<?php echo $this->getObjectVariable($this->filters, 'invitadoReserva_nombre_invitado') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="invitadoReserva_correo_invitado"
							value="<?php echo $this->getObjectVariable($this->filters, 'invitadoReserva_correo_invitado') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Estado Invitado</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono fondo-verde "><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" class="form-control" name="invitadoReserva_estado_invitado"
							value="<?php echo $this->getObjectVariable($this->filters, 'invitadoReserva_estado_invitado') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="invitadoReserva_telefono"
							value="<?php echo $this->getObjectVariable($this->filters, 'invitadoReserva_telefono') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
			...
			<table class=" table table-striped  table-hover table-administrator text-start">
				<thead>
					<tr>
						...
						<td>Correo Invitado</td>
						<td>Estado Invitado</td>
						<td>Telefono invitado</td>
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							<td><?= $content->reserva_id_reserva; ?></td>
							<td><?= $content->invitadoReserva_nombre_invitado . ' ' . $content->invitadoReserva_apellido_invitado; ?></td>
							<td><?= $content->invitadoReserva_correo_invitado; ?></td>
							<td><?= $content->invitadoReserva_estado_invitado; ?></td>
							<td><?= $content->invitadoReserva_telefono; ?></td>
							<td>
