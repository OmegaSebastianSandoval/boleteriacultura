			...
			<div class="row">
				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="categoria_estado" value="<?php echo $this->getObjectVariable($this->filters, 'categoria_estado') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="categoria_precio_socio" value="<?php echo $this->getObjectVariable($this->filters, 'categoria_precio_socio') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Precio socio hijo</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono fondo-morado "><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" class="form-control" name="categoria_precio_socio_hijo" value="<?php echo $this->getObjectVariable($this->filters, 'categoria_precio_socio_hijo') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Precio invitado</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono fondo-cafe "><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" class="form-control" name="categoria_precio_invitado" value="<?php echo $this->getObjectVariable($this->filters, 'categoria_precio_invitado') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							...
							<!-- <td><?= $content->categoria_estado; ?></td> -->
							<td><?= $content->categoria_precio_socio > 0 ? number_format($content->categoria_precio_socio, 0) : ''; ?></td>
