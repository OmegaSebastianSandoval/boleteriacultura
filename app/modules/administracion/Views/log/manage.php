			...
			<div class="row">
				...
				<div class="col-6 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->log_fecha; ?>" name="log_fecha" id="log_fecha"
							class="form-control">
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-6 form-group">
					...
					<textarea name="log_log" id="log_log" class="form-control"
						rows="10"><?= $this->content->log_log; ?></textarea>
					<div class="help-block with-errors"></div>
				</div>
			</div>
		</div>
