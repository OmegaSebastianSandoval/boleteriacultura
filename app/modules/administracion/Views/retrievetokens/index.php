			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="token_token"
							value="<?php echo $this->getObjectVariable($this->filters, 'token_token') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Fecha</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="token_date"
							value="<?php echo $this->getObjectVariable($this->filters, 'token_date') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="token_doc"
							value="<?php echo $this->getObjectVariable($this->filters, 'token_doc') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="token_ncar"
							value="<?php echo $this->getObjectVariable($this->filters, 'token_ncar') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
			...
			<table class=" table table-striped  table-hover table-administrator text-start">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						<?php $id = $content->token_id; ?>
						<tr>
							<td><?= $content->token_token; ?></td>
							<td><?= $content->token_date; ?></td>
							<td><?= $content->token_doc; ?></td>
							<td><?= $content->token_ncar; ?></td>
							<td class="text-end">
								<div>
