...
<table border="1" style="border-collapse: collapse; width: 100%;">
  <!-- <tr>
    <th style="border: 1px solid #000; padding: 8px;">Reserva ID</th>
    <th style="border: 1px solid #000; padding: 8px;">Carnet</th>
    <th style="border: 1px solid #000; padding: 8px;">Nombre</th>
    <th style="border: 1px solid #000; padding: 8px;">Documento</th>
  ...
  <?php foreach ($this->content as $key => $value): ?>
    ...
    <tr style="background-color: #f0f0f0;">
      <td style="border: 1px solid #000; padding: 8px; text-align: left;"><strong>
          Reserva ID: </strong> <?php echo $value->id; ?></td>
      <td style="border: 1px solid #000; padding: 8px; text-align: left;"><strong>
          Carnet:</strong> <?php echo $value->reserva_numero_carnet; ?>
      </td>
      <td style="border: 1px solid #000; padding: 8px; text-align: left;" colspan="4">
        <strong>
          Email:</strong> <?php echo $value->reserva_correo; ?>
      </td>
    </tr>
    ...
    <tr>
      <td style="border: 1px solid #000; padding: 8px; text-align: left;" colspan="6">
    ...
    <?php if (!empty($value->invitados) && is_array($value->invitados)): ?>
      ...
      <?php foreach ($value->invitados as $invitado): ?>
        <tr>
          ...
          <td style="border: 1px solid #000; padding: 8px; text-align: left;">
            <?php echo htmlspecialchars($tipo[$invitado->invitadoReserva_estado_invitado]); ?>
          </td>
        </tr>
      <?php endforeach; ?>
    <?php else: ?>
      ...
      <tr>
        <td style="border: 1px solid #000; padding: 8px;"></td>
        <td style="border: 1px solid #000; padding: 8px;"></td>
        <td style="border: 1px solid #000; padding: 8px; text-align: left;" colspan="3">
