			...
			<div class="row">
				<div class="col-3 d-none">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="termino_estado" value="<?php echo $this->getObjectVariable($this->filters, 'termino_estado') ?>"></input>
					</label>
				</div>
				<div class="col-2">
					<label>Título</label>
					<label class="input-group">
						<input type="text" class="form-control" name="termino_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'termino_titulo') ?>"></input>
					</label>
				</div>
				<div class="col-1">
					<label>&nbsp;</label>
			...
			<table class=" table table-striped  table-hover table-administrator text-start">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						<?php $id =  $content->termino_id; ?>
						<tr>
							<td><?= $content->termino_estado == 1 ? 'Si' : 'No'; ?></td>
							<td><?= $content->termino_titulo; ?></td>
							<td><?= $this->list_secciones[$content->termino_seccion] ?? 'N/A'; ?></td>
							<td>
