			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="informe_nombre"
							value="<?php echo $this->getObjectVariable($this->filters, 'informe_nombre') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>DEscripcion Informe</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono fondo-cafe "><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" class="form-control" name="informe_descripcion"
							value="<?php echo $this->getObjectVariable($this->filters, 'informe_descripcion') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Usuario Actualizacion</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono fondo-azul "><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" class="form-control" name="informes_usuario_actualizacion"
							value="<?php echo $this->getObjectVariable($this->filters, 'informes_usuario_actualizacion') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
			...
			<table class=" table table-striped  table-hover table-administrator text-start">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						<?php $id = $content->informe_id; ?>
						<tr>
							<td><?= $content->informe_nombre; ?></td>
							<td><?= $content->informe_descripcion; ?></td>
							<td><?= $content->informes_usuario_actualizacion; ?></td>
							<td>
