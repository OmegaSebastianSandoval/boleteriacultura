			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="estado_codigo"
							value="<?php echo $this->getObjectVariable($this->filters, 'estado_codigo') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Nombre</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="estado_nombre"
							value="<?php echo $this->getObjectVariable($this->filters, 'estado_nombre') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
			...
			<table class=" table table-striped  table-hover table-administrator text-start">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						<?php $id = $content->estado_id; ?>
						<tr>
							<td><?= $content->estado_codigo; ?></td>
							<td><?= $content->estado_nombre; ?></td>
							<td>
