    ...
    <div class="col-12 fondo-transparente text-center text-white p-4">
        ...
        <?php } else { ?>
            ...
            <p class="texto-final">
                ...
                Mejoramos nuestra experiencia con <strong>

                    boletería 100% en línea.</strong>
                ¡Fácil, rápido y sin filas!
            </p>
...
<style>
    ...
    body {
        background-image: url('/images/<?= $this->eventoConfiguracion->evento_imagenfondo_home ?>') !important;
    ...
    @media screen and (max-width: 985px) {
        ...
        body {
            background-image: url('/images/<?= $this->eventoConfiguracion->evento_imagenfondo_home_responsive ?>') !important;
