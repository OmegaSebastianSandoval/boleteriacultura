                ...
                <tr>
                  <td align="center" valign="top">
                    <div style="background-color:#FFF;padding-top:20px; padding-bottom:20px" width="100%">
                      ...
                      <p style="margin:0"><img src="https://nogalencasa.com/corte/logonegro.png"
                                                    ...
                                                    <?php foreach ($this->boletas as $boleta) { ?>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td
                                                          ...
                                                          align="left">
                                                          <?php
                                                          // Verificar primero en la ruta de nuevas boletas (PDFS_PATH_NEWS)
                                                          $rutaNueva = PDFS_PATH_NEWS . "boleta_cena_" . $boleta["boleta_uid"] . ".pdf";
                                                          // Verificar en la ruta de boletas originales (PDFS_PATH)
                                                          // $rutaOriginal = PDFS_PATH . "boleta_" . $boleta["boleta_uid"] . ".pdf";

                                                          $rutaFinal = null;
                                                          $tipoBoleta = "DESCONOCIDA";

                                                          // Priorizar ruta nueva si existe
                                                          if (file_exists($rutaNueva)) {
                                                            $rutaFinal = $rutaNueva;
                                                            $tipoBoleta = isset($boleta["tipo_envio"]) && $boleta["tipo_envio"] == "NUEVA" ? "NUEVA" : "NUEVA";
                                                          } elseif (file_exists($rutaOriginal)) {
                                                            $rutaFinal = $rutaOriginal;
                                                            $tipoBoleta = isset($boleta["tipo_envio"]) && $boleta["tipo_envio"] == "REENVIADA" ? "REENVIADA" : "ORIGINAL";
                                                          }

                                                          if ($rutaFinal) {
                                                            $rutaEncriptada = urlencode(encryptString($rutaFinal));
                                                            ?>
                                                            <a href="<?= RUTA ?>/page/leerpdf/?token=<?= $rutaEncriptada ?>"
                                                              target="_blank" title="Tipo: <?= $tipoBoleta ?>">
                                                              <?= $boleta["boleta_uid"] ?>
                                                            </a>
                                                            <!-- <small style="color: #999; font-size: 10px;">[<?= $tipoBoleta ?>]</small> -->
                                                          <?php } else { ?>
                                                            <span style="color: #999;"><?= $boleta["boleta_uid"] ?> (PDF no
                                                              disponible)</span>
                                                          <?php } ?>
                                                        </td>
                                                      </tr>
